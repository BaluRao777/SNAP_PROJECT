...
from paths import MODEL_WEIGHTS, MODELS_DIR
...
# Compiling the CNN model with an appropriate optimizer and loss and metrics# adam=Adaptive Moment Estimation,
# # mean_squared_error=which computes the mean of squared differences between the predicted keypoints and the actual keypoints.
...
# Saving the model
save_my_CNN_model(my_model, MODEL_WEIGHTS)
